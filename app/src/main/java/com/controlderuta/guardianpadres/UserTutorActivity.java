...
public class UserTutorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSigPerson        = (FloatingActionButton) findViewById(R.id.btnSigTutor);
        edtNameDriver       = (EditText)findViewById(R.id.nameTutor);
        edtLastNameDriver   = (EditText)findViewById(R.id.lastnameTutor);
        ...
        btnSigPerson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameconductor.equals("")){
                    ...
                    Toasty.info(UserTutorActivity.this,getText(R.string.validadorpersonalnamevacio), Toast.LENGTH_SHORT, true).show();//info del toasty
                ...
                if (lastnameconductor.equals("")){
                    ...
                    Toasty.info(UserTutorActivity.this,getText(R.string.validadorpersonallastnamevacio), Toast.LENGTH_SHORT, true).show();//info del toasty
                ...
                if (autovalidador==2){
                    ...
                    Intent intent = new Intent(UserTutorActivity.this, PhoneActivity.class);
                    ...
                    Toasty.info(UserTutorActivity.this,getText(R.string.validadorpersonal), Toast.LENGTH_SHORT, true).show();//info del toasty
                }
            }
