...
public class UserChildrenActivity extends AppCompatActivity {

    FloatingActionButton btnSigChild;
    EditText edtNameChild;
    EditText edtLastNameChild;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSigChild        = (FloatingActionButton) findViewById(R.id.btnSigChild);
        edtNameChild       = (EditText)findViewById(R.id.nameChild);
        edtLastNameChild   = (EditText)findViewById(R.id.lastnameChild);
        ...
        btnSigChild.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                nameconductor       = edtNameChild.getText().toString();
                lastnameconductor   = edtLastNameChild.getText().toString();
                ...
                if (nameconductor.equals("")){
                    ...
                    Toasty.info(UserChildrenActivity.this,getText(R.string.validadorchildnamevacio), Toast.LENGTH_SHORT, true).show();//info del toasty
                ...
                if (lastnameconductor.equals("")){
                    ...
                    Toasty.info(UserChildrenActivity.this,getText(R.string.validadorchildlastnamevacio), Toast.LENGTH_SHORT, true).show();//info del toasty
                ...
                if (autovalidador==2){
                    ...
                    DatabaseReference mensajeRef = ref.child("usersvstravel").child(Code).child(PruUid).child("childlastname");
                    mensajeRef.setValue(lastnameconductor);

                    DatabaseReference mensajeRef2 = ref.child("usersvstravel").child(Code).child(PruUid).child("childname");
                    mensajeRef2.setValue(nameconductor);


                    Intent intent = new Intent(UserChildrenActivity.this, UserTutorActivity.class);
                    ...
                    Toasty.info(UserChildrenActivity.this,getText(R.string.validadorpersonal), Toast.LENGTH_SHORT, true).show();//info del toasty
                }
            }
